...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // Validación de datos. El código debe tener 3 dígitos y la fecha de inicio no puede ser posterior a la fecha de finalización.
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="stylesheet" href="crear_curso.scss">
